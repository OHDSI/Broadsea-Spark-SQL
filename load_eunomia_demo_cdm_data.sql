...
SELECT 
  ...
  nullif(birth_datetime, '') as birth_datetime, 
  race_concept_id, 
...
SELECT
  ...
  person_id,
  visit_concept_id,
  nullif(visit_start_date, '') as visit_start_date,
  nullif(visit_start_datetime, '') as visit_start_datetime,
  nullif(visit_end_date, '') as visit_end_date,
  nullif(visit_end_datetime, '') as visit_end_datetime,
  nullif(visit_type_concept_id, '') as visit_type_concept_id,
  nullif(provider_id, '') as provider_id,
  nullif(care_site_id, '') as care_site_id,
...
SELECT
  ...
  nullif(visit_detail_start_datetime, '') as visit_detail_start_datetime,
  visit_detail_end_date,
  nullif(visit_detail_end_datetime, '') as visit_detail_end_datetime,
...
SELECT
  ...
  nullif(condition_start_datetime, '') as condition_start_datetime,
  nullif(condition_end_date, '') as condition_end_date,
  nullif(condition_end_datetime, '') as condition_end_datetime,
...
SELECT
  ...
  nullif(drug_exposure_start_datetime, '') as drug_exposure_start_datetime,
  drug_exposure_end_date,
  nullif(drug_exposure_end_datetime, '') as drug_exposure_end_datetime,
  nullif(verbatim_end_date, '') as verbatim_end_date,
...
SELECT
  ...
  procedure_date,
  nullif(procedure_datetime, '') as procedure_datetime,
  nullif(procedure_end_date, '') as procedure_end_date,
  nullif(procedure_end_datetime, '') as procedure_end_datetime,
...
SELECT
  ...
  nullif(device_exposure_start_datetime, '') as device_exposure_start_datetime,
  nullif(device_exposure_end_date, '') as device_exposure_end_date,
  nullif(device_exposure_end_datetime, '') as device_exposure_end_datetime,
...
SELECT 
  ...
  measurement_date, 
  nullif(measurement_datetime, '') as measurement_datetime, 
  nullif(measurement_time, '') as measurement_time, 
  ...
  nullif(unit_concept_id, '') as unit_concept_id, 
  nullif(range_low, '') as range_low, 
  nullif(range_high, '') as range_high, 
  nullif(provider_id, '') as provider_id, 
  nullif(visit_occurrence_id, '') as visit_occurrence_id, 
  nullif(visit_detail_id, '') as visit_detail_id, 
  ...
  nullif(measurement_event_id, '') as measurement_event_id, 
...
SELECT 
  ...
  observation_date, 
  nullif(observation_datetime, '') as observation_datetime, 
...
SELECT
  person_id,
  death_date,
  nullif(death_datetime, '') as death_datetime,
...
SELECT
  ...
  person_id,
  note_date,
  nullif(note_datetime, '') as note_datetime,
...
SELECT 
  ...
  nullif(nlp_system, '') as nlp_system,
  nlp_date, 
  nullif(nlp_datetime, '') as nlp_datetime,
  nullif(term_exists, '') as term_exists,
  nullif(term_temporal, '') as term_temporal,
  nullif(term_modifiers, '') as term_modifiers
...
SELECT 
  ...
  specimen_date, 
  nullif(specimen_datetime, '') as specimen_datetime,
  nullif(quantity, '') as quantity,
  nullif(unit_concept_id, '') as unit_concept_id, 
...
SELECT
            ...
            nullif(amount_value,'') as amount_value,
            nullif(amount_unit_concept_id,'') as amount_unit_concept_id,
            nullif(numerator_value,'') as numerator_value,
            nullif(numerator_unit_concept_id,'') as numerator_unit_concept_id,
            nullif(denominator_value,'') as denominator_value,
            nullif(denominator_unit_concept_id,'') as denominator_unit_concept_id,
            nullif(box_size,'') as box_size,
            valid_start_date,
            valid_end_date,
            nullif(invalid_reason,'') as invalid_reason
...
SELECT
            ...
            nullif(cohort_definition_description,'') as cohort_definition_description,
            definition_type_concept_id,
            nullif(cohort_definition_syntax,'') as cohort_definition_syntax,
            subject_concept_id,
            nullif(cohort_initiation_date,'') as cohort_initiation_date
